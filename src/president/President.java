...
//		publics.add(new Public(new PublicHandler(), Position.Public.MID, DroppableLayout.LayoutType.HEAP, new Point(10,13)));
...
//		publics.add(new Public(new PublicHandler(), Position.Public.TOPMID, DroppableLayout.LayoutType.HEAP, new Point(10,13)));
//		publics.add(new Public(new PublicHandler(), Position.Public.TOPMIDLEFT, DroppableLayout.LayoutType.HEAP, new Point(10,13)));
//		publics.add(new Public(new PublicHandler(), Position.Public.TOPMIDRIGHT, DroppableLayout.LayoutType.HEAP, new Point(10,13)));
